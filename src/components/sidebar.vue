  ...
  <aside class="sidebar position-fixed">
    ...
    <div class="sidelinks-wrapper">
      <ul class="list-unstyled">
        <li>
          <router-link to="/dashboard" class="d-flex flex-nowrap align-items-center">
            <i class="bi bi-speedometer position-relative"></i>
            <p class="mb-0">Dashboard</p>
          </router-link>
        </li>
        <li>
          <router-link to="/users" class="d-flex flex-nowrap align-items-center">
            <i class="bi bi-people position-relative"></i>
            <p class="mb-0">Users</p>
          </router-link>
        </li>
        <li>
          <router-link to="/calendar" class="d-flex flex-nowrap align-items-center">
        ...
        <li>
          <router-link to="/visit" class="d-flex flex-nowrap align-items-center">
        ...
        <li>
          <router-link to="/liveEvent" class="d-flex flex-nowrap align-items-center">
            <i class="bi bi-broadcast position-relative"></i>
            <p class="mb-0">Live Events</p>
          </router-link>
        </li>
        <li class="d-flex flex-wrap align-items-center custom-collapse">
            <a href="#" class="position-relative w-100 d-flex align-items-center" @click="arrowDown($event)">
              <i class="bi bi-collection"></i>
              <p class="mb-0 d-inline-block">All Projects</p>
              <i class="bi bi-chevron-right d-inline-block caret ms-auto me-0"></i>
            </a>
            <ul class="side-collapse submenu w-100">
              <li>
                <router-link to="/profile" class="d-flex flex-wrap align-items-center position-relative">
        ...
        <li class="d-flex flex-wrap align-items-center custom-collapse">
            <a href="#" class="position-relative w-100 d-flex align-items-center" @click.prevent="arrowDown($event)">
            ...
            <ul class="side-collapse submenu w-100">
              <li>
                <router-link to="/tabs" class="d-flex flex-wrap align-items-center position-relative">
                  <p class="mb-0">Tabs</p>
                </router-link>
              </li>
              <li>
                <router-link to="/signature" class="d-flex flex-wrap align-items-center position-relative">
                  <p class="mb-0">Signature</p>
                </router-link>
              </li>
              <li class="d-flex flex-wrap align-items-center custom-collapse">
                <a href="#" class="position-relative w-100 d-flex align-items-center" @click.prevent="innerDropdown($event)">
                  <p class="mb-0 d-inline-block">Inner dropdown 1</p>
                  <i class="bi bi-chevron-right  d-inline-block caret ms-auto me-0 inner-caret position-relative"></i>
                </a>
